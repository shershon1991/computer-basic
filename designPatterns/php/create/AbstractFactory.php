...
echo "ShippableProduct costs: " . $product->calculatePrice() . PHP_EOL;
$product = $factory->createDigitalProduct(150);
echo "DigitalProduct costs: " . $product->calculatePrice() . PHP_EOL;
/*输出
 ShippableProduct costs: 200
 DigitalProduct costs: 150
 */